...
def main():
    ...
    sources += ['Core/MarineSites.cs','Core/UnderwaterGuidance.cs','Core/MissionPresentation.cs','Missions/PortHeistWorld.cs','Missions/PortHeistOperation.cs','Missions/LiveHandoff.cs','Core/VerifySceneStep.cs','Core/OwnedVehicle.cs','Core/Garages.cs']
