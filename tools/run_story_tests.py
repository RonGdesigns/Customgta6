...
def main():
    ...
    sources += ['Core/MarineSites.cs','Core/UnderwaterGuidance.cs','Core/MissionPresentation.cs','Missions/PortHeistWorld.cs','Missions/PortHeistOperation.cs','Core/VerifySceneStep.cs']
