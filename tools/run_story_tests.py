...
def main():
    ...
    sources += ['Core/BoundedPlacement.cs', 'Core/NonlethalGuards.cs', 'Core/MissionDoctor.cs', 'Core/PlacementContract.cs', 'Core/CargoRide.cs', 'Core/GuardAwareness.cs', 'Core/AircraftHold.cs', 'Core/CrewBoarding.cs', 'Core/VehicleSpecs.cs', 'Core/SlowMotion.cs']
