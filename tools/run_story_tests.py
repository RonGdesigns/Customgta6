...
def main():
    ...
    sources += ['Missions/Objectives/BoatDisableObjective.cs','Core/ForkliftCargo.cs','Core/WeaponUpgrades.cs','Core/WeaponMarket.cs','Core/ShopService.Customization.cs','Core/TravelHandling.cs','Core/MissionHandoff.cs','Core/ShopService.cs','Core/WorldTuning.cs','Crew/TacticalResponse.cs','Crew/CrewMemory.cs','Missions/Objectives/TrailerDeliveryObjective.cs','Core/CampaignDispatches.cs','Core/StoryVehicles.cs','Core/CrewHomes.cs','Crew/WeaponProgression.cs','Crew/CrewDriving.cs','Crew/CompanionLife.cs','Crew/PersonalWanted.cs','Crew/MilitaryResponse.cs','Missions/Objectives/StandardObjectives.cs','Missions/Objectives/AdvancedObjectives.cs','Missions/Objectives/InstrumentObjectives.cs','Core/SceneBlocking.cs','Core/PrologueSequence.cs','Core/FleetGarage.cs','Missions/OperationHandoff.cs','Missions/Objectives/TechnicalChoiceObjective.cs','Core/RoadHandling.cs','Core/ControlDiagnostics.cs','Missions/HeliInsertion.cs','Core/VisualAtmosphere.cs','Core/TimecycleGrade.cs','Core/CrewVan.cs','Core/SceneSteps.cs','Core/PropPlacement.cs','Core/SurveyReading.cs','Core/FarPlacement.cs','Core/MissionHud.cs','Core/MissionTally.cs','Core/CrewColors.cs','Crew/CrewOrders.cs','Core/CrewOrderStrip.cs','Core/RaceRoute.cs','Core/RacePacing.cs','Core/RivalGrid.cs','Missions/RoleAction.cs','Missions/RoleTrack.cs','Missions/Objectives/FlowObjectives.cs','Missions/MissionContextCard.cs','Abilities/Ability.cs','Abilities/SlipstreamReflex.cs','Abilities/Blackout.cs','Core/WorldLights.cs']
    sources += [str(p.relative_to(ROOT/'src/Bloodlines')).replace('\\','/') for p in (ROOT/'src/Bloodlines/Missions/Campaign').rglob('*.cs')]
    sources += ['Core/SubmarineAirdrop.cs','Core/AircraftSmoke.cs','Missions/Objectives/ConvoyRouteObjective.cs', 'Core/CrewHomes.Foundry.cs', 'Missions/Objectives/ConvoyOverwatchObjective.cs', 'Core/MarineSites.cs','Core/UnderwaterGuidance.cs','Core/MissionPresentation.cs','Missions/PortHeistWorld.cs','Missions/PortHeistOperation.cs','Missions/LiveHandoff.cs','Core/VerifySceneStep.cs']
    sources += ['Core/MissionPlacement.cs', 'Core/VehiclePanelDamage.cs', 'Missions/CompletionRewards.cs']
    ...
    sources += ['Core/VehicleGround.cs', 'Core/BoundedPlacement.cs', 'Core/NonlethalGuards.cs', 'Core/NonlethalCrew.cs', 'Core/MissionDoctor.cs', 'Core/PlacementContract.cs', 'Core/CargoRide.cs', 'Core/GuardAwareness.cs', 'Core/AircraftHold.cs', 'Core/CrewBoarding.cs', 'Core/VehicleSpecs.cs', 'Core/VehicleStages.cs', 'Core/SlowMotion.cs', 'Core/TargetBlips.cs', 'Core/DlcMaps.cs']
    ...
    sources += ['Core/ScriptedFlight.cs', 'Core/OspreyHangar.cs', 'Missions/Objectives/ShootDownObjective.cs']
