...
def main():
    ...
    production = ['Core/MissionPlacement.cs','Core/SurveyMode.Placement.cs','Core/SurveyMode.Check.cs','Core/SurveyReading.cs','Core/FarPlacement.cs','Crew/CrewDriving.cs','Crew/CrewOrders.cs','Core/RacePacing.cs','Core/RivalGrid.cs','Crew/CompanionRecovery.cs','Crew/CrewDurability.cs','Crew/MilitaryResponse.cs','Crew/CompanionLife.cs','Crew/PersonalWanted.cs','Crew/CompanionConvoy.cs','Crew/CompanionController.cs','Crew/CompanionPresence.cs','Crew/CompanionDriver.cs','Crew/DeathController.cs','Crew/RecoveryMobility.cs','Core/SurveyMode.cs','Core/SurveyCamera.cs','Core/PlacementGhost.cs','Core/RouteRibbons.cs','Core/LocationBook.cs','Core/DataTable.cs','Missions/Objectives/Objective.cs']
