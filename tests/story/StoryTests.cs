...
public static partial class StoryTests
{
 ...
 static void M01Regression(){
  ...
  Check(mission.CurrentStage==3,"Cleared guards trigger Mateo escape and the extraction stage");
 ...
 static void Markers(){
  ...
  Check(markers.Nearby==def&&World.LastBlip.Name=="Bloodlines: Opening"&&!World.LastBlip.ShowRoute&&!World.LastBlip.IsShortRange,"Available mission has a named map icon and proximity start without forced GPS");
