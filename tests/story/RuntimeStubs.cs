...
namespace GTA {
 ...
 public enum HeliMissionFlags {None} public enum VehicleMissionType {GoTo,Circle,Attack,Flee,Ram,Cruise} [System.Flags] public enum VehicleDrivingFlags {None=0,DrivingModeAvoidVehiclesReckless=1,AllowGoingWrongWay=2,UseShortCutLinks=4} public enum BoatMissionFlags {None}
