...
namespace GTA {
 ...
 public class HandlingData {public FlyingHandlingData FlyingHandlingData {get;set;}=new FlyingHandlingData();public BoatHandlingData BoatHandlingData {get;set;}=new BoatHandlingData();public static readonly Dictionary<string,HandlingData> Models=new Dictionary<string,HandlingData>();public static HandlingData GetByVehicleModel(Model model)=>Models.TryGetValue(model.Name,out var value)?value:null;static int next;public IntPtr MemoryAddress=new IntPtr(++next);public bool IsValid=true;public float InitialDriveMaxFlatVelocity=60,InitialDriveForce=.3f,DriveInertia=1f;}
