...
public static partial class StoryTests
{
 ...
 static void CorrectionPassChecks()
 {
  ...
  World.CollisionReady=true;var dockPoint=new Vector3(1073,-3160,5.9f);var traveler=new Ped();var cab=new Vehicle{Position=new Vector3(291,-1078,29)};traveler.SetIntoVehicle(cab,VehicleSeat.Driver);
  Check(PrologueSequence.PlaceForColdOpen(traveler,dockPoint)==PrologueSequence.Placement.Placed&&!traveler.IsInVehicle()&&traveler.Position==dockPoint&&cab.Position!=dockPoint,"The cold open unseats the player before moving them; the car stays behind");
