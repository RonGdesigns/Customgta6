...
public static partial class StoryTests
{
 static void SeptemberRepairChecks()
 {
  ...
  Check(MissionContextCard.Cards.Count==50&&MissionContextCard.Cards.ContainsKey("BM01")&&Enumerable.Range(1,43).All(i=>MissionContextCard.Cards.ContainsKey("M"+i.ToString("00")))&&Enumerable.Range(1,6).All(i=>MissionContextCard.Cards.ContainsKey("SM"+i.ToString("00"))),"Every playable mission has a skipped-briefing target/reason/roles/destination card");
