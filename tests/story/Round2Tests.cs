...
public static partial class StoryTests
{
 static void Round2Checks()
 {
  ...
  GTA.Native.Function.Seabed=-0.5f;Check(MissionSites.Water(c.Locations,"M05.DinghySpawn"),"Half a meter of water under a surveyed spot is trusted: Ron watched boats moor there");
  GTA.Native.Function.Seabed=-0.5f;Check(!MissionSites.Water(c.Locations,"M05.CoveAir")&&GameUtils.Message.Contains("deep enough"),"Half a meter under an estimate is still refused");
