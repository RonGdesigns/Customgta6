...
namespace GTA {
 ...
 public class Tasks {public VehicleMissionType LastMission;public int VehicleMissions;public Ped MissionTarget;public float MissionSpeed;public int MissionFlags;public void StartVehicleMission(Vehicle v,Ped p,VehicleMissionType t,float s,VehicleDrivingFlags f,float r,float straight,bool wrong){VehicleMissions++;LastMission=t;MissionTarget=p;MissionSpeed=s;MissionFlags=(int)f;DriveKind="flee";DriveCalls++;}public void StartScenario(string s,Vector3 p,float h){}public void VehicleShootAtPed(Ped p){Shots++;LastTarget=p;}public int Shots;public void StartHeliMission(Vehicle v,Ped p,VehicleMissionType m,float s,float r,int h,int min,float a,float slow,HeliMissionFlags f){DriveKind="heli-attack";}public int Gotos;public void GoTo(Vector3 p){Gotos++;} public void LeaveVehicle(){owner.CurrentVehicle=null;}public void VehicleChase(Ped p){}public int Wanders;public void WanderAround(Vector3 p,float r){Wanders++;}public void StandStill(int t){}
