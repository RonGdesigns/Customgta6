...
namespace GTA {
 ...
 public enum Control {LookLeftRight,LookUpDown,MoveUpDown,MoveLeftRight,Sprint,Duck,VehicleAccelerate,VehicleBrake}
 public static class Game {public static readonly System.Collections.Generic.Dictionary<Control,float> Axes=new System.Collections.Generic.Dictionary<Control,float>();public static readonly System.Collections.Generic.HashSet<Control> Held=new System.Collections.Generic.HashSet<Control>();public static float GetControlValueNormalized(Control c)=>Axes.TryGetValue(c,out var v)?v:0f;public static bool IsControlPressed(Control c)=>Held.Contains(c);public static float LastFrameTime=.033f;public static bool IsPaused;public static int GenerateHash(string s)=>s.GetHashCode();public static int GameTime; public static float TimeScale=1; public static Player Player=new Player(); public static bool Arrested;}
