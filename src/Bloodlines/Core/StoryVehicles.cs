...
namespace Bloodlines.Core
{
    ...
    public sealed class StoryVehicles
    {
        ...
        public static readonly Choice[] Catalog = {
            ...
            new Choice("Cypher", "cypher", "Cars"), // dialect-ok: the Cypher is the game's own vehicle name
            ...
            new Choice("Ubermacht Sentinel Classic", "sentinel3", "Cars"),
            new Choice("Ubermacht Sentinel Classic Widebody", "sentinel4", "Cars"),
            ...
            new Choice("Overflod Imorgon", "imorgon", "Electric"),
