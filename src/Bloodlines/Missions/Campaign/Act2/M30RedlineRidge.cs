...
namespace Bloodlines.Missions.Campaign
{
    public sealed class M30RedlineRidge : DesertOperation
    {
        ...
        protected override IEnumerable<MissionStage> BuildStages()
        {
            ...
            yield return new MissionStage("Fit the receiver",new MissionInteraction("Gohan: get out and use the laptop beside the delivered parts on the marked bunker workbench",()=>At("M23.ToolBay"),6,animation:MissionInteraction.Typing)).OwnedBy(CrewSlot.Gohan).OnExit(c=>ReceiveSignal());
