...
namespace Bloodlines.Missions.Campaign
{
    public sealed class M43StagingPaleto : CoastalOperation
    {
        ...
        protected override IEnumerable<MissionStage> BuildStages()
        {
            ...
            yield return new MissionStage("Commit the staging plan", new MissionInteraction("Guess: walk to the laptop beside the Paleto landing area and confirm the offshore plan", () => At("M43.BoardWork"), 5, 3f, animation: MissionInteraction.Typing, face: () => _board.Position)).OwnedBy(CrewSlot.Guess)
