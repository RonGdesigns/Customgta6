...
namespace Bloodlines.Missions.Campaign
{
    public sealed class M41TheGeneralsWire : PreparationOperation
    {
        ...
        protected override IEnumerable<MissionStage> BuildStages()
        {
            ...
            yield return new MissionStage("Recover the card", new MissionInteraction("Ice: recover the access card beside Bradley's body", () => _card != null && _card.Exists() ? _card.Position : Bradley.Position, 2, 3f, animation: MissionInteraction.ReachInside)).OwnedBy(CrewSlot.Ice)
