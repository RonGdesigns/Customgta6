...
namespace Bloodlines.Missions
{
    ...
    public static class MissionContextCard
    {
        ...
        public static readonly Dictionary<string, Card> Cards = new Dictionary<string, Card>(System.StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "M23", new Card { Target = "The abandoned radar bunker", Reason = "Replace the lost foundry with a desert base", Roles = "Ice clears; Guess checks bays; Gohan starts the generator", Destination = "Ice: reach the radar yard" } },
