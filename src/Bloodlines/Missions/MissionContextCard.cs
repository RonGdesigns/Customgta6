...
namespace Bloodlines.Missions
{
    ...
    public static class MissionContextCard
    {
        ...
        public static readonly Dictionary<string, Card> Cards = new Dictionary<string, Card>(System.StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "M23", new Card { Target = "The Grand Senora bunker", Reason = "Replace the lost foundry with a desert base", Roles = "Ice secures the entrance; Guess checks the vehicle yard; Gohan powers access and verifies the interior", Destination = "Ice: reach the bunker entrance" } },
