    ...
    public sealed class MissionCatalog
    {
        private static readonly Dictionary<string, Func<Mission>> Scripted =
            new Dictionary<string, Func<Mission>>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                { "M31", () => new M31TheIronPerimeter() },
                { "M32", () => new M32BlackSiteZancudo() },
                { "M33", () => new M33TheInformantsGrave() },
                { "M34", () => new M34MudAndIron() },
                { "M35", () => new M35TheChianskiAmbush() },

                { "M36", () => new M36DeepWellRecon() },
                { "M37", () => new M37TheGrapeseedHarvest() },
                { "M38", () => new M38BloodInTheQuarry() },
                { "M39", () => new M39ThePaletoCable() },
                { "M40", () => new M40ThePhantomRigging() },
                ...
                { "M55", () => new M55SkylineDescent() },
                { "M56", () => new M56IronInTheDrain() },
                { "M58", () => new M58CartelDecapitation() },
                { "M59", () => new M59TheWireCutters() },
                { "M60", () => new M60SiegeOfDavis() },
                { "M61", () => new M61TheBlackBox() },
                { "M62", () => new M62SteelHorizon() },
                { "M63", () => new M63TowerOfGlass() },
                { "M64", () => new M64TheEightiethFloor() },
                { "M65", () => new M65ExecutivePrivilege() },
                { "M66", () => new M66TheSpireEvacuation() },
                { "M67", () => new M67ScorchedGrid() },
                { "M68", () => new M68BloodBrothersTheDrain() },
                { "M69", () => new M69BloodBrothersRunway() },
                { "M70", () => new M70BloodBrothersGroundedTitan() },
