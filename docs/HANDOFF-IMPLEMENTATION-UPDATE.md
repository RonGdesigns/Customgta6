...
131. **M03 again.** Start M03: Ron's car at the base's car spot on the lot. At the junction the dogs come at you and keep coming. The loading is one crate carried in on camera, short. Back at the depot: four at the gate, no dogs; as you pull into the lot three cars come in behind you, Ice warns you once, their crews get out and fight.
132. **M04 again.** The van at the base's car spot. Gohan at his breaker box, Ice up on his ledge; when the lights die the lot goes dark and Ice shoots down. Take Gohan along in the van during the chase: he offers to kill Miller's car, and twelve seconds inside range does it. Lose the police, then drive to the hideout: Ice and Gohan are there, not teleported to you.
130. **Scene skip grace.** Fresh save, drive home: the door scene and the phone scene play through a stop at the door; Enter or A skips a scene only after its first second.
128. **The harbor starts.** Start M18, M19 and M20 from their markers: each starts; the log may say "open water assumed" for a key whose seabed had not streamed in. A refusal now means a deck over the water or shallows at every candidate within the search radius: survey the key.
129. **M03, Gohan in the back.** After the depot fight, Ron in the cab: Ice takes the passenger seat and Gohan walks to the rear doors and is loaded into the box; the doors close; the run starts with both aboard. At the foundry Gohan is set down at the rear doors.
